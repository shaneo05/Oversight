...
namespace ConversionToBoogie
{
    ...
    public class TranslatorContext
    {
        ...
        public TranslatorContext(HashSet<Tuple<string, string>> ignoreMethods, bool _genInlineAttrInBpl, TranslatorFlags translateFlags = null)
        {
        ...
        public void AddFunctionToContract(ContractDefinition contract, FunctionDefinition funcDef)
        {
            ...
            string signature = TranslatorUtilities.ComputeFunctionSignature(funcDef);
        ...
        public FunctionDefinition GetFunctionBySignature(ContractDefinition contract, string signature)
        {
            ...
            {
                if (TranslatorUtilities.ComputeFunctionSignature(funcDef).Equals(signature))
                {
                    return funcDef;
                }
            }
