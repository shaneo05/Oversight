...
namespace ConversionToBoogie
{
    ...
    public class Variable_And_Axiom_Filter
    {
        ...
        public Variable_And_Axiom_Filter(TranslatorContext context)
        {
        ...
        private void GenerateFunctions()
        {
            ...
            context.Program.AddDeclaration(GenerateOverSightSumFunction());
        ...
        private BoogieFunction GenerateOverSightSumFunction()
        {
        ...
        private void GenerateStructConstructors(ContractDefinition contract, StructDefinition structDefn)
        {
            ...
            inParams.AddRange(TranslatorUtilities.GetDefaultInParams());
            foreach(var member in structDefn.Members)
            {
                Debug.Assert(!member.TypeDescriptions.IsStruct(), "Do no handle nested structs yet!");
                var formalType = TranslatorUtilities.GetBoogieTypeFromSolidityTypeName(member.TypeName);
        ...
        private void GenerateAxioms()
        {
            ...
            GenerateOverSightSumAxioms().ForEach(x => context.Program.AddDeclaration(x));
        ...
        private List<BoogieAxiom> GenerateOverSightSumAxioms()
        {
            // axiom(forall m:[Ref]int :: (exists _a: Ref::m[_a] != 0) || _SumMapping_OverSight(m) == 0);
            var qVar1 = QVarGenerator.NewQVar(0, 0);
            var qVar2 = QVarGenerator.NewQVar(0, 1);
            ...
            var sumM = new BoogieFuncCallExpr("_SumMapping_OverSight", new List<BoogieExpr>() { qVar1 });
            ...
            // axiom(forall m:[Ref]int, _a: Ref, _b: int :: _SumMapping_OverSight(m[_a:= _b]) == _SumMapping_OverSight(m) - m[_a] + _b);
            ...
            var sumUpdExpr = new BoogieFuncCallExpr("_SumMapping_OverSight", new List<BoogieExpr>() {updExpr});
        ...
        {
            BoogieType boogieKeyType = TranslatorUtilities.GetBoogieTypeFromSolidityTypeName(mapping.KeyType);
            ...
            {
                boogieValType = TranslatorUtilities.GetBoogieTypeFromSolidityTypeName(mapping.ValueType);
            }
        ...
        private void GenerateMemoryVariablesForArray(ArrayTypeName array, HashSet<KeyValuePair<BoogieType, BoogieType>> generatedTypes)
        {
            ...
            {
                boogieValType = TranslatorUtilities.GetBoogieTypeFromSolidityTypeName(array.BaseType);
            }
