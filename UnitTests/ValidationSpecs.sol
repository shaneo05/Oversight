...
/**
 * Library for OverSight Code Contracts
 * 
...
library OverSight {
    ...
    */
     ...
     * Loop invariant
     *
     * Calling this function within a loop OverSight.Invariant(I) installs
     ...
     * OverSight.ContractInvariant(I) installs I  as a loop invariant
     ...
     * Postconditions
     *
     * Calling this function within a function f OverSight.Ensures(E) installs
     ...
     * Preconditions
     *
     * Calling this function within a function f OverSight.Requires(E) installs
